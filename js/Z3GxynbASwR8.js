...
<a id="like" class="likes-buttons"><div class="icon icon-like"></div></a> \
<a id="dislike" class="likes-buttons"><div class="icon icon-dislike"></div></a>\
</div>\
...
<a href="#" tabindex="1" class="fullScreenOFF smooth noload"></a>\
	...
	function createPlayer(playerGUI, mainPlayer, settings, extras) {
		...
		var options = {
			...
			// Extra Settings
			swfPath: "/new-player/js/Jplayer.swf",
			supplied: formats,
			solution: 'html, flash',
			volume: 0.5,
			size: settings.size,
